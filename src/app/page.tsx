      ...
      <MaxWidthWrapper className='mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center'>
        <div className='mx-auto mb-4 flex max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full border border-gray-200 bg-white px-7 py-2 shadow-md backdrop-blur transition-all hover:border-gray-300 hover:bg-white/90'>
          <p className='text-sm font-semibold text-gray-700'>
            DocWhisperer is now open in beta!
          </p>
        </div>
        ...
        <p className='mt-5 max-w-prose text-zinc-300 sm:text-lg'>
          DocWhisperer allows you to speak with any PDF document. Simply upload your files and start asking questions right away.
        </p>
        ...
        <div className='relative isolate'>
          <div
            ...
            <div
              ...
              className='relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#40fce3] to-[#4652ff] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]'
            />
          </div>
          ...
          <div>
            <div className='mx-auto max-w-6xl px-6 lg:px-8'>
              <div className='mt-16 flow-root sm:mt-24'>
                <div className='-m-2 rounded-xl bg-gray-900/25 p-2 ring-2 ring-inset ring-gray-900/20 lg:-m-4 lg:rounded-2xl lg:p-4'>
                  <Image
