                            ...
                            ({ plan, tagline, quota, features }) => {
                                ...
                                return (
                                    <div
                                        key={plan}
                                        className={cn(
                                            'relative rounded-2xl bg-[#121626] shadow-lg',
                                            {
                                        ...
                                        <div className='flex h-20 items-center justify-center border-b border-t border-gray-400 bg-[#121626]'>
                                                            ...
                                                            <div className='flex items-center space-x-1'>
                                                                <p
                                                                    className={cn(
                                                                        'text-gray-50',
                                                                        {
                                                                            'line-through text-gray-400': negative,
                                                                        }
                                                                    )}>
                                                                    {text}
                                                                </p>
